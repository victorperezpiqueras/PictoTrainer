        ...
        function(e, r, t) {
          ...
          r.exports = function c(e, u, h, r) {
            ...
            function R(e, r, t, a) {
              ...
              else if (h) (l = h.call(f, r, t, a)), !1 !== p.validateSchema && f.validateSchema(l, !0);
          ...
          function c(e, r, t) {
            ...
            return (
              ...
              s instanceof l
                ...
                : void 0 !== s && (o = d(s, this._opts.inlineRefs) ? s : e.call(this, s, r, void 0, i)),
              o
            );
          }
          function u(e, r) {
                ...
                a(e, { allKeys: !0 }, function(e, r, t, a, s, o, i) {
                  if ('' !== r) {
                    var n = p._getId(e),
                      ...
                      c = d[a] + '/' + s;
                    if (
                      (void 0 !== i && (c += '/' + ('number' == typeof i ? i : y.escapeFragment(i))),
                      'string' == typeof n)
                    ) {
          ...
          r.exports = function(e, r) {
            for (var t = 0; t < r.length; t++) {
              ...
              for (a = 0; a < l.length; a++) {
                ...
                n &&
                  (o[i] = {
                    anyOf: [n, { $ref: 'https://raw.githubusercontent.com/epoberezkin/ajv/master/lib/refs/data.json#' }]
                  });
              }
            }
            return e;
      ...
      13: [
        function(e, r, t) {
          ...
          r.exports = function(e, r, t) {
            ...
            a = d
              ? ((s += ' var schema' + o + ' = ' + e.util.getData(n.$data, i, e.dataPathArr) + '; '), 'schema' + o)
              : n;
            var f = 'maximum' == r,
              ...
              !1 !== e.createErrors
                ? ((s +=
                  ...
                  e.opts.verbose &&
                    ...
                    (s += '         , parentSchema: validate.schema' + e.schemaPath + ' , data: ' + h + ' ')),
                  (s += ' } '))
                : (s += ' {} ');
            x = s;
            return (
              ...
              (s +=
                !e.compositeRule && u
                  ? e.async
                    ? ' throw new ValidationError([' + x + ']); '
                    : ' validate.errors = [' + x + ']; return false; '
                  : ' var err = ' + x + ';  if (vErrors === null) vErrors = [err]; else vErrors.push(err); errors++; '),
              (s += ' } '),
              u && (s += ' else { '),
              s
            );
            ...
            return (
              ...
              (s +=
                !e.compositeRule && u
                  ...
                  : ' var err = ' + m + ';  if (vErrors === null) vErrors = [err]; else vErrors.push(err); errors++; '),
              (s += '} '),
              u && (s += ' else { '),
              s
            );
      ...
      16: [
        function(e, r, t) {
          ...
          r.exports = function(e, r, t) {
            ...
            var f = r,
              p = p || [];
            p.push((s += ' Object.keys(' + h + ').length ' + ('maxProperties' == r ? '>' : '<') + ' ' + a + ') { ')),
              (s = ''),
              !1 !== e.createErrors
                ? ((s +=
                    " { keyword: '" +
              ...
              (r.compositeRule = f.compositeRule = y),
                ...
                !1 !== r.createErrors
                  ? ((a +=
                      ...
                      ' , params: {} '),
                    !1 !== r.opts.messages && (a += " , message: 'should match some schema in anyOf' "),
                    r.opts.verbose &&
                      (a +=
                        ' , schema: validate.schema' +
                        n +
            ...
            return (
              !0 === e.opts.$comment
                ...
                : 'function' == typeof e.opts.$comment &&
                  (a += ' self._opts.$comment(' + o + ', ' + e.util.toQuotedString(s) + ', validate.root.schema);'),
              a
            );
          };
        },
      ...
      20: [
        function(e, r, t) {
          ...
          r.exports = function(e, r, t) {
            ...
            var f = f || [];
            f.push((a += 'var ' + h + ' = equal(' + u + ', schema' + s + '); if (!' + h + ') {   ')),
              (a = ''),
              !1 !== e.createErrors
                ? ((a +=
          ...
          r.exports = function(e, r, t) {
            ...
            if (((a += 'var ' + d + ' = errors;var ' + h + ';'), P)) {
              ...
              (e.compositeRule = f.compositeRule = !0),
                ...
                (f.schemaPath = n),
                (f.errSchemaPath = l),
                (a += ' var ' + p + ' = false; for (var ' + m + ' = 0; ' + m + ' < ' + u + '.length; ' + m + '++) { '),
      ...
      22: [
        function(e, r, t) {
          ...
          r.exports = function(e, r, t) {
            ...
            s = m
              ? ((o += ' var schema' + i + ' = ' + e.util.getData(l.$data, n, e.dataPathArr) + '; '), 'schema' + i)
              : l;
            var v,
              y,
              g,
            ...
            if (
              ...
              m &&
                ...
                F && ((_ += '}'), (o += ' ' + f + ' = ' + b + '.validateSchema(' + s + '); if (' + f + ') { '))),
              y)
            )
            ...
            if ((S.modifying && (o += ' if (' + C + ') ' + d + ' = ' + C + '[' + k + '];'), (o += '' + _), S.valid))
              h && (o += ' if (true) { ');
            else {
              var z;
              (o += ' if ( '),
                void 0 === S.valid ? ((o += ' !'), (o += g ? '' + O : '' + f)) : (o += ' ' + !S.valid + ' '),
                (a = w.keyword),
                (z = z || []).push((o += ') { ')),
                (z = z || []).push((o = '')),
                (o = ''),
                  ...
                  ? S.errors
                    ? 'full' != S.errors &&
                      ((o +=
                        ...
                        u +
                        '"; } '),
                      e.opts.verbose && (o += ' ' + $ + '.schema = ' + s + '; ' + $ + '.data = ' + d + '; '),
                      (o += ' } '))
                    : !1 === S.errors
                    ? (o += ' ' + q + ' ')
                    : ((o +=
            ...
            for (var w in ((a += 'var missing' + s + ';'), v))
              if ((P = v[w]).length) {
                if (
                  ...
                  y && (a += ' && Object.prototype.hasOwnProperty.call(' + u + ", '" + e.util.escapeQuotes(w) + "') "),
                  c)
                ) {
                  a += ' && ( ';
                  var b = P;
                  if (b)
                    for (var S = -1, _ = b.length - 1; S < _; ) {
                      (j = b[(S += 1)]),
                        ...
                        y &&
                          (a +=
                            ' || ! Object.prototype.hasOwnProperty.call(' + u + ", '" + e.util.escapeQuotes(j) + "') "),
                        (a +=
                          ') && (missing' + s + ' = ' + e.util.toQuotedString(e.opts.jsonPointers ? j : A) + ') ) ');
                    }
                  a += ')) {  ';
                  var F = 'missing' + s,
                    x = "' + " + F + " + '";
                  e.opts._errorDataPathProperty &&
                    (e.errorPath = e.opts.jsonPointers ? e.util.getPathExpr(E, F, !0) : E + ' + ' + F);
                  var R = R || [];
                  R.push(a),
                    (a = ''),
                    !1 !== e.createErrors
                  ...
                  if (D)
                    for (var j, O = -1, I = D.length - 1; O < I; ) {
                      ...
                      e.opts._errorDataPathProperty && (e.errorPath = e.util.getPath(E, j, e.opts.jsonPointers)),
                        (a += ' if ( ' + C + ' === undefined '),
                        y &&
                          (a +=
                            ' || ! Object.prototype.hasOwnProperty.call(' + u + ", '" + e.util.escapeQuotes(j) + "') "),
            ...
            m.push((a += ' if (!' + h + ') {   ')),
              ...
              !1 !== e.createErrors
                ? ((a +=
                    ...
                    s +
                    ' } '),
                  !1 !== e.opts.messages && (a += " , message: 'should be equal to one of the allowed values' "),
                  e.opts.verbose &&
                    (a +=
                      ' , schema: validate.schema' +
                      n +
        ...
        function(e, r, t) {
          ...
          r.exports = function(e, r, t) {
            ...
            var h,
              d = e.opts.$data && i && i.$data;
            h = d
              ? ((a += ' var schema' + s + ' = ' + e.util.getData(i.$data, o, e.dataPathArr) + '; '), 'schema' + s)
              : i;
            ...
            if (d) {
              ...
              if (!(m = e.formats[i])) {
                if ('ignore' == f)
                  return (
                    e.logger.warn('unknown format "' + i + '" ignored in schema at path "' + e.errSchemaPath + '"'),
                    c && (a += ' if (true) { '),
                    a
                  );
              ...
              if (g) {
                ...
                v && (P += '.validate'),
                  (a += 'function' == typeof m ? ' ' + P + '(' + u + ') ' : ' ' + P + '.test(' + u + ') '),
                  (a += ') { ');
              }
            }
            var E = E || [];
              ...
              !1 !== e.createErrors
                ? ((a +=
                  ...
                  e.opts.verbose &&
                    ...
                    (a += '         , parentSchema: validate.schema' + e.schemaPath + ' , data: ' + u + ' ')),
                  (a += ' } '))
                : (a += ' {} ');
            var w = a;
            return (
              ...
              (e.compositeRule = f.compositeRule = !0),
                ...
                !1 !== e.createErrors
                  ? ((a +=
                      ...
                      E +
                      ' } '),
                    !1 !== e.opts.messages && (a += " , message: 'should match \"' + " + E + " + '\" schema' "),
                    e.opts.verbose &&
                      (a +=
                        ' , schema: validate.schema' +
                        n +
                ...
                b.push((a += '  if (!' + h + ') {   ')),
                  ...
                  !1 !== e.createErrors
                    ? ((a +=
                      ...
                      e.opts.verbose &&
                        (a +=
                          ' , schema: false , parentSchema: validate.schema' + e.schemaPath + ' , data: ' + u + ' '),
                      (a += ' } '))
                    : (a += ' {} ');
                var S = a;
                (a = b.pop()),
            ...
            return (
              ...
              !1 !== e.createErrors
                ? ((a +=
                    ...
                    g +
                    ' } '),
                  !1 !== e.opts.messages && (a += " , message: 'should match exactly one schema in oneOf' "),
                  e.opts.verbose &&
                    (a +=
                      ' , schema: validate.schema' +
                      n +
              ...
              !e.compositeRule &&
                c &&
                (a += e.async ? ' throw new ValidationError(vErrors); ' : ' validate.errors = vErrors; return false; '),
              (a +=
                '} else {  errors = ' +
                d +
                '; if (vErrors !== null) { if (' +
                  ...
                  if (
                    ...
                    if (X) a += ' ' + K + ' ';
                      ...
                      if (I && I[J]) {
                        ...
                        e.opts._errorDataPathProperty && (e.errorPath = e.util.getPath(q, J, e.opts.jsonPointers)),
                ...
                for (var se, oe = -1, ie = ae.length - 1; oe < ie; ) {
                  ...
                  if (
                    ...
                    (d.schema = Y),
                      ...
                      (d.errSchemaPath = e.errSchemaPath + '/patternProperties/' + e.util.escapeFragment(se)),
                      (a += D
                        ? ' ' +
                          P +
                          ' = ' +
              ...
              (d.baseId = w),
                ...
                !1 !== e.createErrors
                  ? ((a +=
                      ...
                      y +
                      "' } "),
                    !1 !== e.opts.messages && (a += " , message: 'property name \\'" + y + "\\' is invalid' "),
                    e.opts.verbose &&
                      (a +=
                        ' , schema: validate.schema' +
                        n +
        ...
        function(e, r, t) {
          ...
          r.exports = function(e, r, t) {
            var a,
              ...
              h = 'valid' + e.level;
            if ('#' == n || '#/' == n)
              s = e.isRoot ? ((a = e.async), 'validate') : ((a = !0 === e.root.schema.$async), 'root.refVal[0]');
            else {
                  ...
                  e.logger.error(f),
                    ...
                    !1 !== e.createErrors
                      ? ((o +=
                          ...
                          "' } "),
                        !1 !== e.opts.messages &&
                          (o += " , message: 'can\\'t resolve reference " + e.util.escapeQuotes(n) + "' "),
                        e.opts.verbose &&
                          (o +=
                            ' , schema: ' +
            ...
            if (d || p.length) {
              ...
              if (c)
                if (((a += ' var missing' + s + '; '), w)) {
                  ...
                  e.opts._errorDataPathProperty && (e.errorPath = e.util.getPathExpr(E, D, e.opts.jsonPointers)),
                    (a += ' var ' + h + ' = true; '),
                    d &&
                      (a +=
                        ' if (schema' +
                    ...
                    (a +=
                      ...
                      x +
                      ']] !== undefined '),
                    b && (a += ' &&   Object.prototype.hasOwnProperty.call(' + u + ', ' + f + '[' + x + ']) '),
                    (a += '; if (!' + h + ') break; } '),
                    d && (a += '  }  '),
                    ($ = $ || []).push((a += '  if (!' + h + ') {   ')),
                    (a = ''),
                  ...
                  if (F)
                    for (var x = -1, R = F.length - 1; x < R; ) {
                      (O = F[(x += 1)]),
                        ...
                        b &&
                          (a +=
                            ' || ! Object.prototype.hasOwnProperty.call(' + u + ", '" + e.util.escapeQuotes(O) + "') "),
                        (a +=
                          ') && (missing' + s + ' = ' + e.util.toQuotedString(e.opts.jsonPointers ? O : C) + ') ) ');
                    }
                  a += ') {  ';
                  var $;
                  S = "' + " + (D = 'missing' + s) + " + '";
                  e.opts._errorDataPathProperty &&
                    (e.errorPath = e.opts.jsonPointers ? e.util.getPathExpr(E, D, !0) : E + ' + ' + D),
                    ($ = $ || []).push(a),
                    (a = ''),
                    !1 !== e.createErrors
                      ? ((a +=
                ...
                if (j)
                  for (var O, I = -1, A = j.length - 1; I < A; ) {
                    ...
                    e.opts._errorDataPathProperty && (e.errorPath = e.util.getPath(E, O, e.opts.jsonPointers)),
                      (a += ' if ( ' + k + ' === undefined '),
                      b &&
                        (a +=
                          ' || ! Object.prototype.hasOwnProperty.call(' + u + ", '" + e.util.escapeQuotes(O) + "') "),
          ...
          r.exports = function(e, r, t) {
            ...
            if (
              ...
              var p = e.schema.items && e.schema.items.type,
                m = Array.isArray(p);
              if (!p || 'object' == p || 'array' == p || (m && (0 <= p.indexOf('object') || 0 <= p.indexOf('array'))))
                s +=
                ...
                (s += ' var itemIndices = {}, item; for (;i--;) { var item = ' + h + '[i]; '),
                  (s += ' if (' + e.util['checkDataType' + (m ? 's' : '')](p, 'item', !0) + ') continue; '),
          ...
          r.exports = function(a, e, r) {
            ...
            if (
              (a.isTop &&
                ((t += ' var validate = '),
                s && ((a.async = !0), (t += 'async ')),
                (t += "function(data, dataPath, parentData, parentDataProperty, rootData) { 'use strict'; "),
                i && (a.opts.sourceCode || a.opts.processCode) && (t += ' /*# sourceURL=' + i + ' */ ')),
                ...
                a.isTop ? (p = !0) : (t += ' var ' + v + ' = false; '),
                  ...
                  !1 !== a.createErrors
                    ? ((t +=
                      ...
                      a.opts.verbose &&
                        (t +=
                          ' , schema: false , parentSchema: validate.schema' + a.schemaPath + ' , data: ' + m + ' '),
                      (t += ' } '))
                    : (t += ' {} ');
                var y = t;
                (t = G.pop()),
            ...
            if (
              (b &&
                a.opts.nullable &&
                !0 === a.schema.nullable &&
                (S ? -1 == b.indexOf('null') && (b = b.concat('null')) : 'null' != b && ((b = [b, 'null']), (S = !0))),
              ...
              !0 !== a.opts.extendRefs &&
                ((o = !1), a.logger.warn('$ref: keywords ignored in schema at path "' + a.errSchemaPath + '"'));
            }
                ...
                if (((t += ' if (' + a.util[S ? 'checkDataTypes' : 'checkDataType'](b, m, !0) + ') { '), _)) {
                  ...
                  (t += ' var ' + x + ' = typeof ' + m + '; '),
                    'array' == a.opts.coerceTypes &&
                      (t += ' if (' + x + " == 'object' && Array.isArray(" + m + ')) ' + x + " = 'array'; "),
                    (t += ' var ' + R + ' = undefined; ');
                  var $ = '',
                    D = _;
                  if (D)
                  ...
                  (G = G || []).push((t += ' ' + $ + ' if (' + R + ' === undefined) {   ')),
                    ...
                    !1 !== a.createErrors
                      ? ((t +=
                        ...
                        (t += "' } "),
                        !1 !== a.opts.messages &&
                          ((t += " , message: 'should be "), (t += S ? '' + b.join(',') : '' + b), (t += "' ")),
                        a.opts.verbose &&
                          (t +=
                            ' , schema: validate.schema' +
                            d +
                  ...
                  (t += ' ' + m + ' = ' + R + '; '),
                    u || (t += 'if (' + A + ' !== undefined)'),
                    (t += ' ' + A + '[' + (u ? a.dataPathArr[u] : 'parentDataProperty') + '] = ' + R + '; } ');
                } else {
                  (G = G || []).push(t),
                    (t = ''),
                    !1 !== a.createErrors
            ...
            if (a.schema.$ref && !o)
              ...
              if (C)
                for (var k = -1, L = C.length - 1; k < L; )
                  if (Y((F = C[(k += 1)]))) {
                    if ((F.type && (t += ' if (' + a.util.checkDataType(F.type, m) + ') { '), a.opts.useDefaults))
                          ...
                          for (var T, q = -1, N = z.length - 1; q < N; ) {
                            if (void 0 !== (V = h[(T = z[(q += 1)])]).default) {
                              ...
                              if (a.compositeRule) {
                                ...
                                (t += ' if (' + Q + ' === undefined '),
                                  'empty' == a.opts.useDefaults && (t += ' || ' + Q + ' === null || ' + Q + " === '' "),
                                  (t += ' ) ' + Q + ' = '),
                                  (t +=
                  ...
                  for (var h in (t(s, o, i, n, l, c, u), s)) {
                    ...
                    if (Array.isArray(d)) {
                      if (h in m.arrayKeywords)
                        for (var f = 0; f < d.length; f++) e(r, t, a, d[f], o + '/' + h + '/' + f, i, o, h, s, f);
            ...
            (function(e) {
              ...
              function r(e) {
                var r = '[A-Za-z]',
                  ...
                  u = k(k(s + '|' + C(l, o, '[\\:]')) + '*'),
                  h =
                    (k(k('25[0-5]') + '|' + k('2[0-4]' + t) + '|' + k('1' + t + t) + '|' + k('[1-9]' + t) + '|' + t),
                    k(
                      k('25[0-5]') + '|' + k('2[0-4]' + t) + '|' + k('1' + t + t) + '|' + k('0?[1-9]' + t) + '|0?0?' + t
                    )),
                  d = k(h + '\\.' + h + '\\.' + h + '\\.' + h),
                  f = k(a + '{1,4}'),
                  p = k(k(f + '\\:' + f) + '|' + d),
              ...
              var N = function(e, r) {
                ...
                l = function(e) {
                  var r,
                    ...
                    n = e.lastIndexOf('-');
                  n < 0 && (n = 0);
                  for (var l = 0; l < n; ++l) 128 <= e.charCodeAt(l) && T('not-basic'), t.push(e.charCodeAt(l));
                  for (var c = 0 < n ? n + 1 : 0; c < a; ) {
                    for (var u = s, h = 1, d = 36; ; d += 36) {
                      a <= c && T('invalid-input');
                      var f =
                        (r = e.charCodeAt(c++)) - 48 < 10 ? r - 22 : r - 65 < 26 ? r - 65 : r - 97 < 26 ? r - 97 : 36;
                ...
                if (s) {
                  ...
                  var y = m
                      .reduce(function(e, r, t) {
                        if (!r || '0' === r) {
                          var a = e[e.length - 1];
                          a && a.index + a.length === t ? a.length++ : e.push({ index: t, length: 1 });
                        }
                        return e;
                      }, [])
                      .sort(function(e, r) {
              ...
              var U = {
                  ...
                  serialize: function(e, r) {
                    return (
                      (e.port !== ('https' !== String(e.scheme).toLowerCase() ? 80 : 443) && '' !== e.port) ||
                        (e.port = void 0),
                      e.path || (e.path = '/'),
                      e
                    );
                ...
                V = { scheme: 'https', domainHost: U.domainHost, parse: U.parse, serialize: U.serialize },
                H = {},
            ...
            (y.prototype.validateSchema = function(e, r) {
              ...
              if (
                !(t =
                  ...
                  ((a = this),
                  (s = a._opts.meta),
                  (a._opts.defaultMeta = 'object' == typeof s ? a._getId(s) || s : a.getSchema(p) ? p : void 0),
                  a._opts.defaultMeta))
              )
                ...
                case 'undefined':
                  return (function(e, r) {
                    ...
                    if (t) {
                      ...
                      return (
                        (e._fragments[r] = new f({ ref: r, fragment: !0, schema: a, root: s, baseId: o, validate: i })),
                        i
                      );
                    }
                  })(this, e);
